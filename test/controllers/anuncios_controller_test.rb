...
class AnunciosControllerTest < ActionController::TestCase
  ...
  test "should create anuncio" do
    assert_difference('Anuncio.count') do
      post :create, anuncio: { contenido: @anuncio.contenido, fecha: @anuncio.fecha, requisitos: @anuncio.requisitos, titulo: @anuncio.titulo, vacante: @anuncio.vacante }
    end
  ...
  test "should update anuncio" do
    patch :update, id: @anuncio, anuncio: { contenido: @anuncio.contenido, fecha: @anuncio.fecha, requisitos: @anuncio.requisitos, titulo: @anuncio.titulo, vacante: @anuncio.vacante }
    assert_redirected_to anuncio_path(assigns(:anuncio))
  end
